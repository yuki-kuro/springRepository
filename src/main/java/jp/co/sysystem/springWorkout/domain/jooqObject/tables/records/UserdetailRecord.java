...
public class UserdetailRecord extends UpdatableRecordImpl<UserdetailRecord> implements Record4<String, String, Timestamp, String> {

    private static final long serialVersionUID = -572763079;
    ...
    @Override
    public UserdetailRecord value1(String value) {
        setNo(value);
        return this;
    }
    ...
    @Override
    public UserdetailRecord values(String value1, String value2, Timestamp value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserdetailRecord(String no, String id, Timestamp birth, String club) {
        super(Userdetail.USERDETAIL);
