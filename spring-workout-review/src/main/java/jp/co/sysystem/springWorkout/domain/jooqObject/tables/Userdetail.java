...
public class Userdetail extends TableImpl<UserdetailRecord> {
    ...
    private static final long serialVersionUID = 2097359214;
    ...
    /**
     * The column <code>workout.userdetail.NO</code>. 管理番号
     */
    public final TableField<UserdetailRecord, Integer> NO = createField(DSL.name("NO"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "管理番号");

    /**
     * The column <code>workout.userdetail.ID</code>. ユーザーID
     */
    public final TableField<UserdetailRecord, String> ID = createField(DSL.name("ID"), org.jooq.impl.SQLDataType.VARCHAR(5).nullable(false), this, "ユーザーID");

    /**
     * The column <code>workout.userdetail.BIRTH</code>. 生年月日
     */
    public final TableField<UserdetailRecord, Timestamp> BIRTH = createField(DSL.name("BIRTH"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "生年月日", new DateAsTimestampBinding());

    /**
     * The column <code>workout.userdetail.CLUB</code>. 委員会
     */
    public final TableField<UserdetailRecord, String> CLUB = createField(DSL.name("CLUB"), org.jooq.impl.SQLDataType.VARCHAR(40), this, "委員会");
    ...
    private Userdetail(Name alias, Table<UserdetailRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("ユーザーマスタ詳細"));
    }
